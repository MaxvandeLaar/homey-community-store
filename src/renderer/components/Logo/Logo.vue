<template>
  <svg :width="size" :height="size" viewBox="0 0 126 125" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <defs>
      ...
      <filter x="-4.0%" y="-4.0%" width="108.0%" height="108.0%" id="filter-6">
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Artboard" transform="translate(-1561.000000, -935.000000)">
        <g id="Community-Store-Logo-Copy" transform="translate(1561.000000, 935.000000)">
          ...
          <g id="Combined-Shape">
            <use :fill="centerColor" fill-rule="evenodd" xlink:href="#path-5"></use>
...
<script>
  export default {
    ...
    computed: {
      centerColor() {
        return this.darkMode ? '#343A41' : '#ffffff';
      }
    }
  }
</script>
